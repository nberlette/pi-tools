...
The Pi 400 already runs at a factory 1.8 GHz, which is significantly faster than
the 1.5 GHz of the 4B. We can take it a step further, however, and clock speeds
of 2 GHz without any throttling. This is primarily thanks to the Pi 400's
massive internal heatsink, which works quite well.
...
Since the 4B runs at 1.5 GHz, it's wise to start around 1.8 GHz, instead of 2+
GHz right out the door. Active cooling is _mandatory_ for overclocking the 4B.
You will experience throttling almost immediately without adequate cooling.
